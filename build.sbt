...
def modules = Seq(dsl, random, log, system, io, filesystem, tool, error)
...
lazy val error = Project(id = "errorhandle", base = file("dsls/errorhandle")).settings(settings: _*) dependsOn(dsl)
